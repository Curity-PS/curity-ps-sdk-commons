...
class TestConstants {
    /**
     * Constants used for the GraphQL client
     */
    ...
    /**
     * Constants used for the TestOAuthClient
     */
    static class CodeFlow {
        public static final String CLIENT_ID = "integration-test-client"
        public static final String CLIENT_SECRET = "integration-test-secret"
